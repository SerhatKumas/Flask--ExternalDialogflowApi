...
def scrape_crypto_com():
    ...
    for main_page_anchors in soup.find_all('a', href=True):
        if main_page_anchors['href'] != "/en/" and main_page_anchors[
            'href'] != "https://facebook.com/CryptoComOfficial" and \
    ...
    for anchor in all_main_page_anchors:
        ...
        for in_page_anchors in soup.find_all('a', href=True):
            if in_page_anchors['href'] != "/en/" and in_page_anchors[
                'href'] != "https://facebook.com/CryptoComOfficial" and \
                    in_page_anchors['href'] != "https://twitter.com/cryptocom" and in_page_anchors[
                'href'] != "https://linkedin.com/company/cryptocom" \
